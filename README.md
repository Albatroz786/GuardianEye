...
o	Email: Sends an alert message and an image attachment of the "theft" scene using smtplib.
o	SMS: Sends a text notification via the Twilio API.
...
3.	Click Send Verification Code and enter the OTP received in your email.
4.	Click Select Object to Monitor. A camera window will open.
5.	Draw a box around the object you want to protect and press ENTER or SPACE.
6.	The system is now live! If the object is moved, you will receive an alert.
